...
Output Format: In each line of output there should be two columns: The first column contains the String and
is left justified using exactly 15 characters.
...
public class PrintF {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i<3; i++) {
            String s1 = sc.next();
            int x = sc.nextInt();
            // %-15s - string com margem esquerda com 15 espaços do primeiro char até o primeiro dígito do próximo do int
